...
window.DIAGRAMS = [
  {id:'flow', name:'流程圖', en:'Flowchart', when:'步驟有先後、有分岔、可能回頭', example:'研究流程、規劃許可的審查流程、資料清理的步驟',
   say:'把我的研究流程畫成流程圖：先確定研究問題，然後讀文獻，接著收集資料、分析、寫討論。如果分析時資料不夠就回頭收集；如果讀文獻後發現問題太大就回頭修改研究問題。',
  ...
  {id:'framework', name:'架構圖／概念框架', en:'Framework diagram', when:'有哪些部分、怎麼分層、什麼影響什麼', example:'論文的概念框架、治理層級（中央、區域、地方）、資料來源架構',
   say:'幫我畫概念框架圖：左邊是影響因素，分成「政策層級」和「在地條件」兩組框起來；中間是我要解釋的「可負擔住宅供給」；右邊是結果「居住負擔」。用箭頭表示影響方向。',
  ...
  {id:'gantt', name:'甘特圖', en:'Gantt chart', when:'什麼時候做到哪、哪件事要等前一件做完', example:'論文時程表、研究計畫書的期程、小組專案分工',
   say:'幫我畫論文時程的甘特圖：從一月開始，分準備、執行、寫作三段。文獻回顧兩個月，研究設計一個月，資料收集兩個月，分析一個月，初稿一個月，修改與提交一個月。每一項都要等前一項做完。',
  ...
  {id:'timeline', name:'時間軸', en:'Timeline', when:'一件事怎麼一段一段演變', example:'一個地區的發展階段、一項制度的變化、一個政策議題怎麼浮現',
   say:'幫我畫時間軸：一個舊工業區分四個階段，工業期、衰退期、再生期、今日，每個階段列兩個重點。',
  ...
  {id:'mindmap', name:'心智圖', en:'Mind map', when:'一個主題怎麼展開成幾個面向', example:'文獻回顧的主題地圖、一個議題的拆解、seminar 前整理想法',
   say:'幫我把「可負擔住宅」的文獻分成供給面、需求面、政策工具、測量方式四個面向，展開成心智圖，每個面向兩到三個子題。',
  ...
  {id:'quadrant', name:'象限圖', en:'Quadrant chart', when:'用兩個標準把一群東西排位置', example:'利害關係人的影響力與關切度矩陣、方案的影響與可行性',
   say:'幫我畫利害關係人矩陣：橫軸是關切度、縱軸是影響力。地方政府規劃部門影響力高關切高，開發商兩者都偏高，社區團體關切高影響低，一般居民兩者偏低，大學研究單位兩者中低。四個象限分別標密切合作、維持滿意、觀察即可、持續告知。',
